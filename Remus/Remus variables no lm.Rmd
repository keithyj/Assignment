...
par(mfrow=c(2,2))
scatter.smooth(cancer2$povertyPercent, cancer2$deathRate, lpars=list(col = "red", lwd = 2, xlab="deathRate",xlab="povertyPercent"))
scatter.smooth(cancer2$PctPrivateCoverage, cancer2$deathRate, lpars=list(col = "red", lwd = 2),ylab="deathRate", xlab="PctPrivateCoverage")
scatter.smooth(cancer2$PctPublicCoverage, cancer2$deathRate, lpars=list(col = "red", lwd = 2),ylab="deathRate",
xlab="PctPublicCoverage")
scatter.smooth(cancer2$PctEmpPrivCoverage, cancer2$deathRate, lpars=list(col = "red", lwd = 2),ylab="deathRate",
xlab="PctEmpPrivCoverage")
```

All four are linear.
PctEmpPrivCoverage, PctPublicCoverage are potentially heteroscadastic.

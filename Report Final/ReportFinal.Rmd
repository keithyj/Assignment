...
```{r findings plots, echo = FALSE, fig.cap = "Some key plots to show Skewness, Heteroscedasticity and Linearity respectively", fig.asp = 0.35}
par(mfrow = c(1,3))

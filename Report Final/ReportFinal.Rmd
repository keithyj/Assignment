...
```{r findings plots, echo = FALSE, fig.cap = "Some key plots to express Skewness, Heteroscedasticity and Linearity respectively", fig.asp = 0.4}
par(mfrow = c(1,3))
...
We have a severe number of outliers in medIncome. This is most likely due to natural circumstances such as a CEO of a large company or a doctor earning a higher salary (@HighPayJob). The boxplot for incidenceRate shows the existence of an extreme high value.

...
* **Missing values have been identified to likely be missing completely at random and therefore we suggest that it can be removed. Some data for the AvgHouseholdSize data is likely to be incorrect and a new data source should be used to gather correct figures, or identify incorrect figures.**

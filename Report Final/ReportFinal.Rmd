...
* Apply appropriate transformations to fix cases of non-linearity, heteroscedasticty, skewness and non-normality to satisfy the model assumptions.
* Further investigate outliers to ensure they do not have undue influence when we build a model.
* Perform further analysis on highly correlated predictor variables to check for multicollinearity.

...
Some variables, most notably PctBlack and medIncome, are skewed and we tested simple power transformations to fix the skewness, which proved effective. However, due to a massive right skew in PctBlack, we could not completely remove the skewness and so this needs to be further explored when fitting a model.
...
We have a severe number of outliers in medIncome. This is most likely due to natural circumstances such as a CEO of a large company or a doctor (@HighPayJob).
